...
public interface CanaryCooldownReceivingInventory {
     ...
     * the transfer.
     * NOTE: Canary does not replace all of vanilla's item transfers. Mod authors still need to implement
     * their own hooks for vanilla code even when they require users to install Canary.
     *
