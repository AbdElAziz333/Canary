...
public class CombinedHeightmapUpdate {
    ...
    public static void updateHeightmaps(Heightmap heightmap0, Heightmap heightmap1, Heightmap heightmap2, Heightmap heightmap3,
        ...
        Predicate<BlockState> blockPredicate1 = heightmap1 == null ? null : Objects.requireNonNull(((HeightmapAccessor) heightmap1).getOpaque());
        Predicate<BlockState> blockPredicate2 = heightmap2 == null ? null : Objects.requireNonNull(((HeightmapAccessor) heightmap2).getOpaque());
        Predicate<BlockState> blockPredicate3 = heightmap3 == null ? null : Objects.requireNonNull(((HeightmapAccessor) heightmap3).getOpaque());

        if (heightmap0 != null) {
            if (blockPredicate0.test(state)) {
                if (y >= height0) {
                    ((HeightmapAccessor) heightmap0).set(x, z, y + 1);
                }
                heightmap0 = null;
                heightmapsToUpdate--;
            } else if (height0 != y + 1) {
        ...
        if (heightmap1 != null) {
            if (blockPredicate1.test(state)) {
                if (y >= height1) {
                    ((HeightmapAccessor) heightmap1).set(x, z, y + 1);
                }
                heightmap1 = null;
                heightmapsToUpdate--;
            } else if (height1 != y + 1) {
        ...
        if (heightmap2 != null) {
            if (blockPredicate2.test(state)) {
                if (y >= height2) {
                    ((HeightmapAccessor) heightmap2).set(x, z, y + 1);
                }
                heightmap2 = null;
                heightmapsToUpdate--;
            } else if (height2 != y + 1) {
        ...
        if (heightmap3 != null) {
            if (blockPredicate3.test(state)) {
                if (y >= height3) {
                    ((HeightmapAccessor) heightmap3).set(x, z, y + 1);
                }
                heightmap3 = null;
                heightmapsToUpdate--;
            } else if (height3 != y + 1) {
        ...
        for (int searchY = y - 1; searchY >= bottomY && heightmapsToUpdate > 0; --searchY) {
            ...
            if (heightmap0 != null && blockPredicate0.test(blockState)) {
                ((HeightmapAccessor) heightmap0).set(x, z, searchY + 1);
                heightmap0 = null;
                heightmapsToUpdate--;
            }

            if (heightmap1 != null && blockPredicate1.test(blockState)) {
                ((HeightmapAccessor) heightmap1).set(x, z, searchY + 1);
                heightmap1 = null;
                heightmapsToUpdate--;
            }

            if (heightmap2 != null && blockPredicate2.test(blockState)) {
                ((HeightmapAccessor) heightmap2).set(x, z, searchY + 1);
                heightmap2 = null;
                heightmapsToUpdate--;
            }

            if (heightmap3 != null && blockPredicate3.test(blockState)) {
                ((HeightmapAccessor) heightmap3).set(x, z, searchY + 1);
                heightmap3 = null;
                heightmapsToUpdate--;
            }
        }
        ...
        if (heightmap0 != null) {
            ((HeightmapAccessor) heightmap0).set(x, z, bottomY);
        }

        if (heightmap1 != null) {
            ((HeightmapAccessor) heightmap1).set(x, z, bottomY);
        }

        if (heightmap2 != null) {
            ((HeightmapAccessor) heightmap2).set(x, z, bottomY);
        }

        if (heightmap3 != null) {
            ((HeightmapAccessor) heightmap3).set(x, z, bottomY);
        }
    }
}
