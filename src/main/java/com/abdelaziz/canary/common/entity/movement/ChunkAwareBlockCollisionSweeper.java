...
public class ChunkAwareBlockCollisionSweeper extends AbstractIterator<VoxelShape> {
    ...
    public ChunkAwareBlockCollisionSweeper(CollisionView view, Entity entity, Box box) {
        ...
        this.minX = MathHelper.floor(box.minX - LithiumEntityCollisions.EPSILON);
        this.maxX = MathHelper.floor(box.maxX + LithiumEntityCollisions.EPSILON);
        this.minY = MathHelper.clamp(MathHelper.floor(box.minY - LithiumEntityCollisions.EPSILON), Pos.BlockCoord.getMinY(this.view), Pos.BlockCoord.getMaxYInclusive(this.view));
        this.maxY = MathHelper.clamp(MathHelper.floor(box.maxY + LithiumEntityCollisions.EPSILON), Pos.BlockCoord.getMinY(this.view), Pos.BlockCoord.getMaxYInclusive(this.view));
        this.minZ = MathHelper.floor(box.minZ - LithiumEntityCollisions.EPSILON);
        this.maxZ = MathHelper.floor(box.maxZ + LithiumEntityCollisions.EPSILON);
