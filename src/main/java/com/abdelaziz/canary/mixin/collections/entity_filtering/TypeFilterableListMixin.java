package com.abdelaziz.canary.mixin.collections.entity_filtering;
...
/**
 * Patches {@link ClassInstanceMultiMap<>.class} to improve performance when entities are being queried in the world.
 */
